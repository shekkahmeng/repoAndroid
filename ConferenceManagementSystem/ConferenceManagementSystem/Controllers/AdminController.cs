...
namespace ConferenceManagementSystem.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Username,Password,Name,Email,PhoneNumber,Address")] Admin admin)
        {
            if (ModelState.IsValid)
            {
                admin.Password = Function.Encrypt(admin.Password);
                db.Admins.Add(admin);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Username,Password,Name,Email,PhoneNumber,Address")] Admin admin)
        {
            if (ModelState.IsValid)
            {
